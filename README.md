...
catfood_bar supports live configuration via `~/.config/catfood_bar/config.json`. The first time you run the application, a default configuration file will be created.
...
All errors are logged to `~/.local/share/catfood_bar/logs/catfood_bar.log` in ISO format:
```
